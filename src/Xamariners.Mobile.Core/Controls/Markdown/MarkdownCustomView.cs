...
{
    public class MarkdownCustomView : ContentView
    {
        ...
        public static readonly BindableProperty MarkdownProperty = BindableProperty.Create(nameof(Markdown), typeof(string), typeof(MarkdownCustomView), null, propertyChanged: OnMarkdownChanged);
        ...
        public static readonly BindableProperty RelativeUrlHostProperty = BindableProperty.Create(nameof(RelativeUrlHost), typeof(string), typeof(MarkdownCustomView), null, propertyChanged: OnMarkdownChanged);
        ...
        public static readonly BindableProperty ThemeProperty = BindableProperty.Create(nameof(Theme), typeof(MarkdownTheme), typeof(MarkdownCustomView), Global, propertyChanged: OnMarkdownChanged);
        ...
        {
            var view = bindable as MarkdownCustomView;
            view.RenderMarkdown();
        }
                ...
                view.GestureRecognizers.Add(new TapGestureRecognizer
                {
                    Command = new Command(async () =>
                    {
                        try
                        {
                            ...
                            {
                                var result = await Application.Current.MainPage.DisplayActionSheet("Open link", "Cancel", null, blockLinks.Select(x => x.Key).ToArray()).ConfigureAwait(true);
